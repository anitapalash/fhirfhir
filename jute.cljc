...
(def standard-fns
  {:join str/join       ;; deprecated
   ...
   :randDateGaussian (fn [m d] (jute-fns/make-date-gaussian m d))
   :makeRandPeriod (fn [s d dsp] (jute-fns/make-rand-period
                                  s
                                  (cheshire/parse-string d true)
                                  (cheshire/parse-string dsp true)))

   :complicatedHash jute-fns/complicated-hash
   :md5 jute-fns/md5
